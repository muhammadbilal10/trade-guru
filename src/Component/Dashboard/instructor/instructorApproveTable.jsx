...
export default function EditTable() {
    ...
    useEffect(() => {
        // Function to get documents where status is false
        const getDocumentsWithStatusFalse = async () => {
            ...
            try {
                ...
                console.log('Documents with status false:', documents);
                setUser(documents);
                // Set the documents to the state or perform any other actions
                // For example: setInstructor(documents);
            } catch (error) {
        ...
        fetchUserData(db, 'Instructor').then(data => {
            setInstructor(data);

            // After fetching all documents, call the function to get status=false documents
            getDocumentsWithStatusFalse();
        });
