      ...
      <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
        <div class="w-full overflow-x-auto">
          <table class="w-full bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            <thead>
              <tr class="text-sm font-semibold tracking-wide text-left text-gray-700 uppercase border-b dark:border-gray-700 bg-gray-200 dark:bg-gray-700">
                <th class="px-6 py-3">#</th>
                <th class="px-6 py-3">Symbol</th>
                <th class="px-6 py-3">Shares</th>
                <th class="px-6 py-3">Price</th>
                <th class="px-6 py-3">Daily Change</th>
              </tr>
            </thead>
            <tbody>
              {transactions.map((transaction, index) => (
                <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" key={index}>
                  ...
                  <td class="px-6 py-4">{processedSymbols[transaction.symbol] !== undefined ? transaction.dailyChange : 'Loading...'}</td>
                </tr>
              ))}
            </tbody>
          </table>
