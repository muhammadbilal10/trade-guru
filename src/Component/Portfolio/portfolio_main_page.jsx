    ...
    return (
        <>
            ...
            <div class="flex flex-row">
                ...
                <div class="basis-1/2">
                    <object class="bg-gray-50" data="https://sarmaaya.pk/public/widgets/company-snapshot?stock_symbol=HBL"

                        width="100%" height="540" type="text/html"> Company Snapshot </object>
                </div>
            ...
            <div>
                ...
                <h2>Current Price for {symbol}</h2>
                <p>Price: {price}</p>
